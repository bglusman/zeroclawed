...
use nonzeroclaw::providers::compatible::AuthStyle;
use nonzeroclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use nonzeroclaw::providers::compatible::OpenAiCompatibleProvider;
