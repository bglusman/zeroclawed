...
use nonzeroclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
...
fn factory_ollama_with_custom_api_url() {
    assert_provider_ok("ollama", None, Some("http://10.0.0.90:11434"));
}
...
fn factory_resolves_openai_codex_provider() {
    let options = nonzeroclaw::providers::ProviderRuntimeOptions::default();
