...
/// `NonZeroClaw` — Opinionated first-party PolyClaw agent.
#[derive(Parser, Debug)]
#[command(name = "nonzeroclaw")]
#[command(author = "PolyClaw Contributors")]
#[command(version)]
#[command(about = "OpenAI-compatible HTTP agent for the PolyClaw ecosystem.", long_about = None)]
struct Cli {
