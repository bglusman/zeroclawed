...
pub struct Config {
    ...
    /// Vault configuration for Bitwarden/Vaultwarden-backed credential management (`[vault]`).
    #[serde(default)]
...
pub struct ChannelsConfig {
    ...
    ///
    /// NOTE: NZC does not yet have a notify/push mechanism for inline tool call
    /// messages, so this field is currently a no-op stub. Wire into a future
