...
impl AgentAdapter for AcpAdapter {
    ...
    async fn dispatch_with_context(
        ...
        // The context preamble from nonzeroclawed's ring buffer is still useful for
        ...
        .on_receive_request(
            |request: RequestPermissionRequest,
             ...
             _cx: JrConnectionCx<ClientToAgent>| async move {
                // Auto-approve tool permissions (nonzeroclawed trusts its agents;
