...
//!
//! Configures NonZeroClawed to route messages to one or more downstream "claws"
...
//! - **Non-interactive CLI** (`--nonzeroclawed-host` / `--claw` flags present):
...
pub use model::{ClawKind, ClawTarget, InstallTarget, NonZeroClawedTarget, WebhookFormat};
