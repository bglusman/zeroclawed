//! JSON5 / JSONC comment stripping for NonZeroClawed's installer.
//!
...
//! # Why a separate copy?
//!
//! `nonzeroclawed` does not depend on `nonzeroclaw` (to avoid circular crate
//! dependencies and to keep nonzeroclawed independently distributable).  Until a
//! shared `claw-types` crate is extracted, this module is the authoritative
//! copy for use within `nonzeroclawed`.
//!
//! # TODO (follow-on)
//!
