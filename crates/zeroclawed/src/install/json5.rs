//! JSON5 / JSONC comment stripping for ZeroClawed's installer.
//!
...
//! # Why a separate copy?
//!
//! `zeroclawed` does not depend on `nonzeroclaw` (to avoid circular crate
//! dependencies and to keep zeroclawed independently distributable).  Until a
//! shared `claw-types` crate is extracted, this module is the authoritative
//! copy for use within `zeroclawed`.
//!
//! # TODO (follow-on)
//!
