# Agents of Chaos — Lessons for ZeroClawed/NZC
...
**ZeroClawed hook point:** Clash crate policy enforcement could require verification for high-impact actions.
...
**ZeroClawed hook point:** `auth.rs` `resolve_channel_sender` — map senders to permission tiers.
...
**ZeroClawed hook point:** Per-sender webhook history (50 turns) partially addresses this — ensure suspicion flags survive.
...
- **Per-sender webhook history** in ZeroClawed — 50 turns of context per sender
